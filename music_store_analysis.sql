...
--Write a query that returns the Artist name and totaal track count of the top 10 rock bands
...
--Q9. Find how much amount spent by each customer in artists?
...
--Q11. Writ4e a query that determines the customer that has spent the most on music for each country.
